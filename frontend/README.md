<div align="center">
  <h1>🖥️ OncoShield AI - Medical Portal</h1>
  <p>The official Clinical Frontend Interface, developed by <strong><a href="https://ufuq-tech.com/">Ufuq Tech</a></strong>.</p>
</div>
...
Open [http://localhost:3000](http://localhost:3000) with your browser to access the OncoShield AI interface.

## 🔗 Connected Ecosystem

This frontend is designed to strictly communicate with the OncoShield FastAPI backend. For API configuration or webhook setups, refer to the in-app Documentation page or consult the [Ufuq Tech Engineering Hub](https://ufuq-tech.com/).
