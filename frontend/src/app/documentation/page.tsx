    ...
    <div className="mx-auto flex min-h-screen w-full max-w-screen-2xl">
          ...
          <div>
            ...
            <ul className="space-y-1">
              <li>
                ...
                >
                  <span className="material-symbols-outlined text-xl">rocket_launch</span> Getting
                  Started
                </a>
              </li>
              <li>
                ...
                >
                  <span className="material-symbols-outlined text-xl">auto_awesome</span> System
                  Overview
                </a>
              </li>
              <li>
                <a
                  ...
                  href="#model-accuracy"
                >
                  <span className="material-symbols-outlined text-xl">verified_user</span> Clinical
                  Accuracy
                </a>
              </li>
            </ul>
            ...
            <ul className="space-y-1">
              ...
              <li>
                <a
                  ...
                  href="#sdks"
                >
                  <span className="material-symbols-outlined text-xl">data_object</span> SDKs &
                  Libraries
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-1">
              ...
              <li>
                ...
                >
                  <span className="material-symbols-outlined text-xl">gavel</span> Regulatory
                  Standards
                </a>
              </li>
              <li>
                <a
                  ...
                  href="#hipaa"
                >
                  <span className="material-symbols-outlined text-xl">security</span> HIPAA
                  Compliance
                </a>
              </li>
            </ul>
      ...
      <div className="max-w-4xl flex-1 px-8 py-12 md:px-16 md:py-16">
        <header id="getting-started" className="mb-12 scroll-mt-24">
          ...
          <p className="font-body-lg text-on-surface-variant max-w-2xl text-[18px] leading-relaxed">
            ...
            Our Artificial Neural Network (ANN) models provide real-time malignant detection with
            99.8% precision, designed specifically to assist oncologists in making rapid,
            evidence-based decisions.
          </p>
          <p className="font-body-md text-on-surface-variant mt-4 max-w-2xl text-[16px] leading-relaxed">
            Whether you are integrating our system into an existing EHR (Electronic Health Record)
            software or building a standalone diagnostic portal, this documentation covers
            everything from basic system architecture to advanced webhook implementations.
          </p>
        </header>
        ...
        <div className="space-y-20">
          ...
          <section id="system-architecture" className="scroll-mt-24">
            ...
            <p className="mb-8 leading-relaxed text-slate-500">
              The OncoShield AI engine utilizes a multi-layered diagnostic pipeline. The process
              ensures that raw medical imagery is properly cleaned and standardized before passing
              through the deep learning classification model.
            </p>
            <div className="group relative mb-8 aspect-[3.35] w-full overflow-hidden rounded-2xl border border-slate-100 shadow-sm">
              <img
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
              <div className="rounded-xl border border-slate-100 bg-white p-6 shadow-sm">
                <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-full bg-sky-100 font-bold text-sky-600">
                  1
                </div>
                <h4 className="mb-2 font-bold text-slate-800">Pre-processing</h4>
                <p className="text-sm text-slate-500">
                  DICOM/SVS images are normalized, artifacts removed, and regions of interest (ROI)
                  are dynamically cropped to ensure zero interference from external noise.
                </p>
              </div>
              <div className="rounded-xl border border-slate-100 bg-white p-6 shadow-sm">
                <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-full bg-sky-100 font-bold text-sky-600">
                ...
                <h4 className="mb-2 font-bold text-slate-800">Feature Extraction</h4>
                <p className="text-sm text-slate-500">
                  Morphological parameters (Radius, Texture, Perimeter, Area, Smoothness) are
                  extracted automatically using the core Convolutional layers.
                </p>
              </div>
              <div className="rounded-xl border border-slate-100 bg-white p-6 shadow-sm">
                <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-full bg-sky-100 font-bold text-sky-600">
                ...
                <h4 className="mb-2 font-bold text-slate-800">Classification</h4>
                <p className="text-sm text-slate-500">
                  The ANN outputs a probability distribution across Benign/Malignant classes with a
                  confidence threshold, attaching clinical protocol recommendations.
                </p>
              </div>
            </div>
          </section>
          ...
          <section id="model-accuracy" className="scroll-mt-24">
            ...
            <p className="mb-8 leading-relaxed text-slate-500">
              Our model has been rigorously validated against historical datasets containing over
              50,000 anonymized breast cancer screening cases. The precision matrix below
              illustrates the latest Q3 2025 Retrospective Study findings.
            </p>
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
              ...
              <div className="ai-insight-panel flex flex-col justify-between rounded-xl border border-transparent p-6 [background:linear-gradient(#ffffff,#ffffff)_padding-box,linear-gradient(to_right,#006194,#545c72)_border-box]">
                <div>
                  ...
                  <p className="font-body-sm text-on-surface-variant text-[14px] leading-relaxed">
                    We employ a &quot;Human-in-the-Loop&quot; architecture, ensuring AI findings are
                    always presented as second opinions for clinical confirmation. AI should assist,
                    not replace, medical experts.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section id="api-integration" className="scroll-mt-24">
            ...
            <p className="font-body-md text-on-surface-variant mb-6 text-[16px]">
              Use our RESTful API to submit pathology slides and receive immediate diagnostic
              analysis. The API supports batch processing and asynchronous inference for high-volume
              hospitals.
            </p>
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
              ...
              <div className="group relative">
                <div className="absolute top-0 left-0 rounded-tl-lg rounded-br-lg bg-slate-700 px-3 py-1 font-mono text-xs text-slate-300">
                  Python SDK
                </div>
                ...
                <pre className="font-code overflow-x-auto rounded-lg bg-[#0d1117] p-6 pt-10 text-[13px] leading-relaxed text-slate-200">
                  <code>
                    <span className="text-pink-400">import</span> oncoshield_ai
                    <br />
                    <br />
                    <span className="text-slate-500"># Initialize the clinical client</span>
                    <br />
                    client = oncoshield_ai.Client(api_key=
                    <span className="text-emerald-400">"YOUR_KEY"</span>)<br />
                    <br />
                    <span className="text-slate-500"># Submit biopsy scan</span>
                    <br />
                    analysis = client.diagnostics.analyze(
                    <br />
                    &nbsp;&nbsp;source_path=
                    <span className="text-emerald-400">"./slide_001.svs"</span>,<br />
                    &nbsp;&nbsp;modality=<span className="text-emerald-400">"histopathology"</span>,
                    <br />
                    &nbsp;&nbsp;priority=<span className="text-emerald-400">"stat"</span>
                    <br />
                    )<br />
                    <br />
          ...
          <section id="webhooks" className="scroll-mt-24">
            ...
            <p className="mb-6 leading-relaxed text-slate-500">
              Configure webhooks to receive real-time HTTP POST notifications when a diagnostic
              analysis is complete. This avoids the necessity of active polling of our API, reducing
              server load on your end.
            </p>
                ...
                <tbody className="divide-y divide-slate-100">
                  <tr>
                    ...
                    <td className="py-4 text-slate-500">
                      Triggered when the AI successfully processes a case and classification is
                      ready.
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="py-4 text-slate-500">
                      Triggered if image quality is too low for inference or metadata is missing.
                    </td>
                  </tr>
                  <tr>
                    <td className="py-4 font-mono text-sky-600">model.retrained</td>
                    <td className="py-4 text-slate-500">
                      Triggered when a new model weight snapshot is deployed to production.
                    </td>
                  </tr>
                </tbody>
              </table>
          ...
          <section id="sdks" className="scroll-mt-24">
            ...
            <p className="mb-6 leading-relaxed text-slate-500">
              We provide officially supported SDKs for Node.js and Python to speed up your
              integration process. These libraries handle automatic retries, authentication
              formatting, and payload compression out of the box.
            </p>
            <div className="flex flex-col gap-4">
              <div className="flex items-center justify-between rounded-lg bg-slate-900 p-4 text-white">
                <code className="font-mono text-sm">
                  <span className="text-sky-400">npm</span> install @oncoshield/node-sdk
                </code>
                <span className="material-symbols-outlined cursor-pointer text-slate-500 transition-colors hover:text-white">
                  content_copy
                </span>
              </div>
              <div className="flex items-center justify-between rounded-lg bg-slate-900 p-4 text-white">
                <code className="font-mono text-sm">
                  <span className="text-sky-400">pip</span> install oncoshield-ai
                </code>
                <span className="material-symbols-outlined cursor-pointer text-slate-500 transition-colors hover:text-white">
                  content_copy
                </span>
          ...
          <section id="data-privacy" className="scroll-mt-24 border-t border-slate-100 pt-16">
            ...
            <p className="mb-6 leading-relaxed text-slate-500">
              Patient data security is our highest priority. All PHI (Protected Health Information)
              is automatically de-identified before entering our inference engine. Raw scans are
              kept entirely within memory during inference and are permanently purged upon response
              generation, ensuring zero data retention.
            </p>
            <div className="bg-surface-dim/20 border-surface-variant mt-8 rounded-2xl border p-8">
              <div className="flex flex-col items-center gap-8 md:flex-row">
                <div className="flex-1">
                  ...
                  <p className="font-body-md text-on-surface-variant mb-6 text-[16px]">
                    All transit traffic is secured via TLS 1.3. At rest (during the brief inference
                    window), data is shielded using AES-256 encryption. We utilize strictly isolated
                    virtual private clouds (VPCs) to ensure cross-tenant data boundaries.
                  </p>
                ...
                <div className="flex h-32 w-32 items-center justify-center rounded-full border border-blue-100 bg-blue-50">
          ...
          <section id="regulatory-standards" className="scroll-mt-24">
            ...
            <p className="mb-6 leading-relaxed text-slate-500">
              OncoShield AI adheres strictly to international regulatory frameworks. Our clinical
              validation studies have been submitted to the FDA under the Software as a Medical
              Device (SaMD) categorization framework. Furthermore, our infrastructure is
              independently audited annually to maintain our <strong>ISO 27001</strong>{' '}
          ...
          <section id="hipaa" className="scroll-mt-24">
            ...
            <p className="mb-6 leading-relaxed text-slate-500">
              For institutions operating within the United States, OncoShield AI operates as a
              compliant Business Associate. We provide comprehensive Business Associate Agreements
              (BAAs) upon enterprise onboarding. Our architecture is designed from the ground up
              with strict Access Controls, Audit Controls, and Integrity mechanisms matching the
              strict guidelines of the HIPAA Security Rule.
            </p>
          </section>
          ...
          <div className="mt-16 flex items-center justify-between border-t border-slate-100 pt-12">
            <a className="group flex items-center gap-3" href="#webhooks">
              <div className="border-outline-variant group-hover:bg-surface-container-low flex h-10 w-10 items-center justify-center rounded-full border transition-colors">
                <span className="material-symbols-outlined text-slate-500 group-hover:text-sky-600">
                  arrow_back
                </span>
              </div>
      ...
      <aside className="sticky top-[65px] hidden h-[calc(100vh-65px)] w-64 py-16 pr-8 xl:block">
        ...
        <ul className="space-y-4 border-l border-slate-100 pl-4">
          <li className="mt-6 mb-2 -ml-4 pl-4 text-xs font-bold tracking-widest text-slate-400 uppercase">
            Introduction
          </li>
          <li>
            <a
              className="font-body-sm text-primary border-primary -ml-[18px] block border-l-2 pl-4 text-[14px] font-semibold"
              href="#getting-started"
            >
              Getting Started
            </a>
          ...
          <li>
            <a
              className="font-body-sm block text-[14px] text-slate-500 transition-colors hover:text-sky-600"
              href="#system-architecture"
            >
              System Overview
            </a>
          ...
          <li className="mt-8 mb-2 -ml-4 pl-4 text-xs font-bold tracking-widest text-slate-400 uppercase">
            Integration
          </li>
          <li>
            <a
