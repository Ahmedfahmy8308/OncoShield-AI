      ...
      <section className="px-margin-desktop py-stack-xl mx-auto max-w-screen-2xl">
        <div className="gap-gutter grid grid-cols-1 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-12">
            <div>
              <h2 className="font-h2 text-[28px] font-semibold mb-4 text-slate-800">1. Business Associate Agreements (BAA)</h2>
            ...
            <div>
              <h2 className="font-h2 text-[28px] font-semibold mb-4 text-slate-800">2. Technical Safeguards</h2>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-slate-600"><strong>Encryption:</strong> All ePHI is encrypted in transit using TLS 1.3 and at rest using AES-256 encryption algorithms.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="material-symbols-outlined text-primary text-xl">password</span>
                  <span className="text-slate-600"><strong>Access Control:</strong> Multi-Factor Authentication (MFA) is mandatory. Access to systems containing PHI operates on a strict principle of least privilege.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="material-symbols-outlined text-primary text-xl">manage_search</span>
                  <span className="text-slate-600"><strong>Audit Controls:</strong> Comprehensive logging is enforced across all endpoints. Every action involving ePHI—including read, write, and delete operations—is permanently recorded.</span>
                </li>
              </ul>
            </div>

            <div>
              <h2 className="font-h2 text-[28px] font-semibold mb-4 text-slate-800">3. Physical & Administrative Safeguards</h2>
              <p className="text-slate-600 leading-relaxed mb-4">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-slate-600"><strong>Data Centers:</strong> Our servers are hosted in ISO 27001 and SOC 2 Type II certified data centers with 24/7 biometric security and physical surveillance.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="material-symbols-outlined text-primary text-xl">model_training</span>
                  <span className="text-slate-600"><strong>Staff Training:</strong> All <a href="https://ufuq-tech.com/" target="_blank" rel="noopener noreferrer" className="text-sky-600 hover:underline font-semibold">Ufuq Tech</a> engineers and OncoShield personnel undergo mandatory, ongoing HIPAA privacy and security training.</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-surface-container-low p-8 rounded-xl border border-slate-100 shadow-sm">
              <span className="material-symbols-outlined text-primary text-4xl mb-4">description</span>
              <h3 className="font-h3 text-[20px] font-bold mb-2">Request a BAA</h3>
              ...
              <button className="w-full bg-primary text-white py-3 rounded-lg font-semibold hover:bg-sky-700 transition-colors">
                Contact Legal Team
              </button>
            </div>
